...
export default function SendMessage() {
  const [initialMessageString, setinitialMessageString]= useState<string>("What's your favorite movie?||Do you have any pets?||What's your dream job?");
  ...
  const fetchSuggestedMessages = async () => {
    ...
    try {
      ...
      setinitialMessageString(response.data.message);
    }
    catch (error: any) {
